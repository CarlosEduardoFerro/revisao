...
// precoTotal(produtos, quantidades)
// console.log(precoTotal(produtos, quantidades))
...
// const buscaProdutoPorPreco = (preco, arrayProdutos)=>{
//   let precoMinimo = 20
//   return arrayProdutos.filter((produto) => produto.preco >= precoMinimo)
// }
// buscaProdutoPorPreco('20', produtos)
// console.log(buscaProdutoPorPreco('20', produtos))
